MIS - Multithread Instrumentation Simulator

Apenas as configurações para eclipse foram importadas.
Usando:
	Eclipse Helios (www.eclipse.org)
	Plugin Subclipse 1.6.x (http://subclipse.tigris.org/)
	Java-SE 1.6
	
Caso deseja usar outra IDE importar configurações necessárias.
